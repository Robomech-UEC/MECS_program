...
## 端子台
### ターミナルブロック
ネジで線を止めることができます。試作にはいいでしょう。  
![terminal](imgs/015_terminal.png)

### ワンタッチコネクタ
はんだ付け、カシメが必要ないコネクタ。  
空中配線に使われることが多いです。  
![ontouch](imgs/015_one_touch.png)
...
### コルゲートチューブ
ザクです。  
![colgate](imgs/015_colgate.png)  

### スパイラルケーブルラップ
名前が分かんないやつです。100均でよく売ってるらしいです。
![spiral](imgs/015_spilar.png)
